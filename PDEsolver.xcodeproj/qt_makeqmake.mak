...
QMAKE    = /usr/bin/qmake
PDEsolver.xcodeproj/project.pbxproj: PDEsolver.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o PDEsolver.xcodeproj/project.pbxproj PDEsolver.pro
