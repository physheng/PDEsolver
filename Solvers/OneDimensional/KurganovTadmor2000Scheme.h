#ifndef __TIMESOLVER_CLASS_KURGANOVTADMOR2000SCHEME__
#define __TIMESOLVER_CLASS_KURGANOVTADMOR2000SCHEME__

#include "MainSolverClass.h"

class KurganovTadmor2000Scheme:public MainSolverClass{
