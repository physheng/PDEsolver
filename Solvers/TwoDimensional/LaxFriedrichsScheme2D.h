#ifndef __TIMESOLVER_CLASS_LAXFRIEDRICHSSCHEME_2D__
#define __TIMESOLVER_CLASS_LAXFRIEDRICHSSCHEME_2D__

#include "MainSolverClass2D.h"

class LaxFriedrichsScheme2D:public MainSolverClass2D{
